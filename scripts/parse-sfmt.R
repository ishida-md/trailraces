...
sfmt2015_rawm <- extract_tables("input/result2015m.pdf", encoding = 'UTF-8')
sfmt2015_rawf <- extract_tables("input/result2015w.pdf", encoding = 'UTF-8')

sfmt2015_raw <- c(sfmt2015_rawm, sfmt2015_rawf)
...
sfmt2017_rawm <- extract_tables("input/result2017_m160.pdf", encoding = 'UTF-8')
sfmt2017_rawf <- extract_tables("input/result2017_w160.pdf", encoding = 'UTF-8')

sfmt2017_raw <- c(sfmt2017_rawm, sfmt2017_rawf)
